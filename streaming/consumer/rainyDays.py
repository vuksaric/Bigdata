...
try:
  ...
  weather = weather.withColumn("Precipitation_total",col("Precipitation_1") + col("Precipitation_2") + col("Precipitation_3") + col("Precipitation_4") + col("Precipitation_5") + col("Precipitation_6") + col("Precipitation_7") ) \
                   .withColumn("Rainy_day", when(col("Precipitation_total") > 2.5, "Rainy").otherwise("Not rainy")) \
                   .groupBy("Rainy_day").count()
