...
try:
  ...
  weather = weather.withColumn("Visibility_avg",(col("Visibility_1") + col("Visibility_2") + col("Visibility_3") + col("Visibility_4") + col("Visibility_5") + col("Visibility_6") + col("Visibility_7")) / 7 ) \
                   .agg(avg("Visibility_avg"))
